...
int main()
{
	...
	double pctFor = 10.00 * forImpeachment / numberSurveyed;
	...
	if (forImpeachment > antiImpeachment)
		cout << "More people oppose impeachment than oppose it." << endl;
	else
		cout << "More people support impeachment than support it." << endl;
}